...
import { usePreferences, useUpdatePreferences } from '@/features/notifications/notifications.queries'
import type { PreferencesResponse } from '@/features/notifications/notifications.api'
